    ...
    <SafeAreaView style={styles.screen} edges={['bottom']}>
      ...
      <KeyboardAvoidingView style={{ flex: 1 }} behavior={Platform.OS === 'ios' ? 'padding' : undefined}>
        <ScrollView contentContainerStyle={styles.scrollContent} keyboardShouldPersistTaps="handled">
          ...
          {selectedCustomer && !invoicesLoading && invoices.length === 0 && returOptions.length === 0 && (
            <View style={styles.card}>
              <View style={{ alignItems: 'center', gap: 6, paddingVertical: 10 }}>
                <Ionicons name="checkmark-done-circle-outline" size={30} color="#94a3b8" />
                ...
                <Text style={{ fontSize: 10.5, color: '#94a3b8', textAlign: 'center' }}>
                  Pelanggan ini tidak memiliki faktur piutang maupun retur yang bisa diproses.{'\n'}
                  Silakan pilih pelanggan lain.
                </Text>
              </View>
            </View>
          )}
