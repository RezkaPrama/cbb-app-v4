...
const HistorySales: React.FC = () => {
    ...
    const handleScanQR = () => {
        ...
        // Sesuaikan nama route dengan navigator Anda
        try {
            (navigation as any).navigate('TrackHistoryScreen');
        } catch {
            Alert.alert('Info', 'Route TrackHistoryScreen belum terdaftar di navigator.');
        }
    };
            ...
            >
                ...
                <View style={styles.headerRow}>
                    <View style={styles.textBlock}>
                        ...
                        <Text style={styles.title}>History Sales</Text>

                        <Text style={styles.subtitle}>
                            Histori Tracking Kunjungan anda.
                        </Text>
                    </View>
                    ...
                    <View style={styles.iconCircle}>
                        <Animated.View style={{ transform: [{ scale: pulseAnim }] }}>
                            <FeatherIcon name="map" size={24} color="#8fb2ff" />
                        </Animated.View>
                    </View>
                </View>
                ...
                <View style={styles.buttonsRow}>
                    ...
                    >
                        <FeatherIcon name="map-pin" size={13} color="#fff" style={{ marginRight: 6 }} />
                        <Text style={styles.btnScanText}>Lihat Histori</Text>
                    </TouchableOpacity>
                </View>
